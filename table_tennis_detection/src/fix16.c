...
bool fix16_largerThan(int16_t data, fix16_t thresh){
	//compare int part
	int16_t intpartthresh = fix16_to_int(thresh);
	if(data > intpartthresh) return true;
	else return false;
}

bool fix16_smallerThan(int16_t data, fix16_t thresh){
	//compare int part
	int16_t intpartthresh = fix16_to_int(thresh);
	if(data < intpartthresh) return true;
	else return false;
